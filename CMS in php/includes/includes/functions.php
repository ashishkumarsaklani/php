...
function navigation($subjects_array,$pages_array,$step1_array) {
		...
		$output .= "</a> </li>";
								...
								{$output .= " class=\"selected\" ";}
								$output .= ">" ;
								$output .= "<a href=\"manage_content.php?step1=";
...
function find_selected_pages($public =false) {
	...
	}	else {	$current_pages = null;$current_step1 =null;
	}
	}	elseif(isset($_GET["pages"])) {
		if(isset($_GET["step1"])){$current_step1 =find_step1_by_id($_GET["step1"],$public);}else{$current_step1=null;}
