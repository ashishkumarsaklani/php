		...
		<?php  echo message(); ?>
			...
			+ <a href ="new_pages.php?subjects=<?php echo urlencode($current_subjects["id"]);?>">Add a new page to <?php echo $current_subjects["menu_name"];?></a>
														...
														<h2>Manage <?php echo $current_step2["menu_name"];?> </h2>
															...
															<a href="edit_step2.php?pages=<?php echo urlencode($page);?>&step2=<?php echo urlencode($current_step2["id"]); ?>"> Edit <?php echo $current_step2["menu_name"];?> </a>
											...
											<a href="edit_step1.php?pages=<?php  echo urlencode($current_step1["pages_id"]);?>&step1=<?php echo urlencode($current_step1["id"]); ?>"> Edit <?php echo $current_step1["menu_name"];?></a>
						...
						<a href="edit_pages.php?pages=<?php echo urlencode($current_pages["id"]); ?>"> Edit <?php echo $current_pages["menu_name"];?></a>
