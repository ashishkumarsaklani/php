...
//continue if no errors
	if(empty($errors)){
		...
		$query .= " username, hashed_password,pic ) ";
		$query .= "values (";
		$query .= " '{$username}', '{$hashed_password}', '$imageData' ";
		$query .= ");";
...
(function() {
    $('form > input').keyup(function() {
		...
		<form action ="new_admins.php" method="post" enctype="multipart/form-data">
		...
		&nbsp;
					...
					<input type="submit" name="submit" value="Submit" />
							&nbsp; &nbsp<a href="manage_admins.php">Cancel </a>
		</form>	
		<br/> 
	</div>
